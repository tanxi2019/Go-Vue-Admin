...
import { getMenuTree, createMenu, updateMenuById, batchDeleteMenuByIds } from '@/api/permission/menu'
...
export default {
  ...
  methods: {
    ...
    update(row) {
      ...
      console.log(this.dialogFormData.parentId)
        ...
        if (valid) {
          ...
          try {
            if (this.dialogType === 'create') {
              ...
              const { msg } = await updateMenuById(dialogFormDataCopy.ID, this.dialogFormData)
              message = msg
            }
          } finally {
